...
public sealed class X509Authority
{
        ...
        TimeSpan validity)
    {
        ...
        X509ExtensionBuilder.AddCaExtensions(request);
        ...
        IReadOnlyCollection<string>? subjectAltNames = null)
    {
        ...
        X509ExtensionBuilder.AddLeafExtensions(request, kind, subjectAltNames);
    ...
    // -- extension builders (X509ExtensionBuilder.cs) ----------------------
    // The AddCaExtensions + AddLeafExtensions methods live in
    // X509ExtensionBuilder.cs — pure-function helpers, stateless.
