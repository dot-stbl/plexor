...
/// <param name="Total">Total matching rows across all pages (before
/// pagination).</param>
/// <param name="Page">The page number returned (1-based, mirrors
/// <c>FilterQuery.Page</c>).</param>
/// <param name="PageSize">The page size used (mirrors
/// <c>FilterQuery.PageSize</c>).</param>
