...
public static class PlexorCli
{
    ...
    /// <param name="args">
    ///     Raw command-line arguments (typically
    ///     passed straight from <c>Main</c>).
    /// </param>
...
internal sealed class PlexorCliContent
{
    ...
    ///     <see cref="ClusterName" /> / <see cref="NodeName" /> / default.
    /// </summary>
    ...
    /// <summary>
    ///     Deferred <see cref="IConfigurator" /> actions,
    ///     flushed during <see cref="PlexorCliBuilder.Run" />.
    /// </summary>
...
public sealed class PlexorCliBuilder
{
    ...
    /// <summary>
    ///     Mutable state of the builder. Internal data shape
    ///     shared with the branch builder and runner.
    /// </summary>
    ...
    /// <summary>
    ///     Set the version string used for <c>--version</c>.
    ...
    /// <summary>
    ///     Set the explicit tagline shown under the banner or
    ...
    /// <summary>
    ///     Node context for the status footer (optional).
    ...
    /// <summary>
    ///     Resolve the tagline as plain text (no markup),
...
internal sealed class PlexorBranchContent
{
    ...
    /// <summary>
    ///     Deferred command configurations, flushed when the
    ///     parent builder's <see cref="PlexorCliBuilder.Run" /> executes.
    /// </summary>
