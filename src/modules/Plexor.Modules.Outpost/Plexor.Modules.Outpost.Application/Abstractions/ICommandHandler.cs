...
// ============================================================================
// ICommandHandler — single-method command handler contract. Mirrors the
// Clusters module's ICommandHandler<TCommand, TResult>; kept local to
// Outpost for module independence. When a 3rd module needs the same
// shape, extract to Plexor.Shared.Kernel.
// ============================================================================
