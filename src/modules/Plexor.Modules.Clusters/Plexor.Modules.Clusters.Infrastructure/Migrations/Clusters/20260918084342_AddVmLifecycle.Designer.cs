...
namespace Plexor.Modules.Clusters.Infrastructure.Migrations.Clusters
{
    ...
    [Migration("20260918084342_AddVmLifecycle")]
    partial class AddVmLifecycle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Plexor.Modules.Clusters.Domain.Cluster", b =>
                {
            ...
            modelBuilder.Entity("Plexor.Modules.Clusters.Domain.Entities.Workload", b =>
                {
                    ...
                    b.Property<string>("ProviderVmId")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
            ...
            modelBuilder.Entity("Plexor.Modules.Clusters.Domain.Entities.WorkloadLifecycleEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("WorkloadId", "Id")
                        .HasDatabaseName("ix_workload_lifecycle_events_workload_id_id");

                    b.ToTable("workload_lifecycle_events", "forge");
                });

            modelBuilder.Entity("Plexor.Modules.Clusters.Domain.JoinToken", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)")
            ...
            modelBuilder.Entity("Plexor.Modules.Clusters.Domain.Node", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)")
            ...
            modelBuilder.Entity("Plexor.Modules.Clusters.Domain.Entities.WorkloadLifecycleEvent", b =>
                {
                    b.HasOne("Plexor.Modules.Clusters.Domain.Entities.Workload", null)
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Plexor.Modules.Clusters.Domain.JoinToken", b =>
                {
                    b.HasOne("Plexor.Modules.Clusters.Domain.Cluster", null)
                        .WithMany()
