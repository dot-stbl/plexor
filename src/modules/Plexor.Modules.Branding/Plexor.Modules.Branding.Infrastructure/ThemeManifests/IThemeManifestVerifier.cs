...
/// <summary>
///     Sign a community-theme manifest via HMAC-SHA256 over the
///     canonical manifest bytes (declared-order JSON → UTF-8). Key
///     material is derived from the host's
///     <c>IDataProtectionProvider</c>; production deployments rotate
///     keys via the standard data-protection key ring.
/// </summary>
