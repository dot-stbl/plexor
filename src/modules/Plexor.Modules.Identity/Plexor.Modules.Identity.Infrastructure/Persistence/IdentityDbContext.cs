...
namespace Plexor.Modules.Identity.Infrastructure.Persistence;
...
///     the main read paths: login lookup (tenant_id + email),
///     refresh-token validation (family_id), API-key validation
///     (revoked_at IS NULL), tenant-scoped role/user queries.
/// </summary>
internal sealed class UserConfiguration : IEntityTypeConfiguration<User>
{
    public void Configure(EntityTypeBuilder<User> builder)
    {
        ...
        builder.Property(static user => user.TenantId)
        ...
        // Email is unique per tenant (cross-tenant users are Phase 2).
        builder.HasIndex(static user => new { user.TenantId, user.Email })
            .HasDatabaseName("ix_sigil_users_tenant_id_email")
            .IsUnique();

        // Tenant-scoped user list queries (admin endpoints).
        builder.HasIndex(static user => new { user.TenantId, user.Status })
...
internal sealed class RoleConfiguration : IEntityTypeConfiguration<Role>
{
    public void Configure(EntityTypeBuilder<Role> builder)
    {
        ...
        builder.Property(static role => role.TenantId)
            .HasColumnName("tenant_id")
            .HasColumnType("uuid")
            .IsRequired();
        ...
        builder.HasIndex(static role => new { role.TenantId, role.Name })
...
internal sealed class RoleBindingConfiguration : IEntityTypeConfiguration<RoleBinding>
{
    public void Configure(EntityTypeBuilder<RoleBinding> builder)
    {
        ...
        builder.Property(static binding => binding.TenantId)
            .HasColumnName("tenant_id")
            .HasColumnType("uuid")
            .IsRequired();
        ...
        builder.Property(static binding => binding.ProjectId)
        ...
        // Can't bind the same role to the same scope twice.
        builder.HasIndex(static binding => new { binding.UserId, binding.RoleId, binding.ProjectId })
...
internal sealed class ApiKeyConfiguration : IEntityTypeConfiguration<ApiKey>
{
    public void Configure(EntityTypeBuilder<ApiKey> builder)
    {
        ...
        builder.Property(static key => key.TenantId)
            .HasColumnName("tenant_id")
            .HasColumnType("uuid")
            .IsRequired();
        ...
        builder.HasIndex(static key => new { key.TenantId, key.RevokedAt })
...
internal sealed class SshKeyConfiguration : IEntityTypeConfiguration<SshKey>
{
    public void Configure(EntityTypeBuilder<SshKey> builder)
    {
        ...
        builder.HasIndex(static key => new { key.TenantId, key.Fingerprint })
