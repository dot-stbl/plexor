...
{
    /// <summary>Wire command type this executor handles (e.g.
    /// <c>"workload.create"</c>). Matched against
    /// <see cref="CommandEnvelope.Type"/>.</summary>
    public string Type { get; }

    /// <summary>Run the command and return the result. The
...
/// <c>CompletedAt = UtcNow</c>.</summary>
/// <param name="Status">Whether the work succeeded or failed.</param>
/// <param name="ErrorMessage">Required when <paramref name="Status"/>
/// is <see cref="CommandResultStatus.Failed"/>; null otherwise.</param>
