...
const CELL = requireBentoCell('quotas-audit');
const CONTENT = requireServiceContent('quotas-audit');

export const Route = createFileRoute('/(marketing)/services/quotas-audit/')({
  component: Page,
  head: () => ({
    meta: [
...
function Page() {
  return <ServicePage id="quotas-audit" />;
}