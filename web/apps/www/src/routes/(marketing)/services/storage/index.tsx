...
const CELL = requireBentoCell('storage');
const CONTENT = requireServiceContent('storage');

export const Route = createFileRoute('/(marketing)/services/storage/')({
  component: Page,
  head: () => ({
    meta: [
