...
/**
 * Ported verbatim from `web/apps/console/src/shared/ui/primitives/badge.tsx`
 * — only import paths adjusted (`@/shared/ui/primitives/polymorphic` →
 * `@/components/ui/polymorphic`).
 */
...
function Badge({
  ...
  variant = "default",
  ...props
}: PolymorphicProps<"span"> & VariantProps<typeof badgeVariants>) {
  return polymorphic(
    "span",
    props,
