...
/**
 * Plexor Dialog — react-aria-components-backed. Ported verbatim from
 * `web/apps/console/src/shared/ui/primitives/dialog.tsx` (only the
 * `@/shared/ui/primitives/button` import was adjusted to `@/components/ui/button`).
 *
