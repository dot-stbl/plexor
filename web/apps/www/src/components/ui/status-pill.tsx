...
/**
 * StatusPill — compact status indicator (dot + label). Ported verbatim
 * from `web/apps/console/src/shared/ui/primitives/status-pill.tsx` (only
 * the `@/shared/lib/utils` import was adjusted to `@/lib/utils`).
 *
 ...
 *
 * www convention (this app, not console's): the changelog / spectrum /
 * comparison sections reuse this primitive with English children text —
 * `<StatusPill variant="ok">Shipped</StatusPill>`, `variant="warn"` for
 * "Next", `variant="idle"` for "Design" — see `src/content/changelog/*`
 * and `marketing-spectrum.tsx` (owned by the landing/changelog agents).
 */
