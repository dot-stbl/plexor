...
import { mapVmStatusToVariant } from '../model/vm-status';
...
export function getVmColumns(t: TFunction): ColumnDef<Vm>[] {
  return [
    ...
    },
    {
      ...
      meta: {
        size: 'w-[110px]',
        // `eu-west-1a` — matches the mock fleet's actual zones (see
        // mocks/network/networks.ts), technical example, kept literal
        // (not localized).
        filter: { type: 'text', param: 'zone', placeholder: 'eu-west-1a' },
      },
    },
    {
      id: 'flavor',
