  ...
  return (
    ...
    >
      <svg
        ...
        stroke="currentColor"
        strokeWidth={3}
        className="grid size-3.5 place-content-center text-current transition-none group-data-[selected]/checkbox:opacity-100 group-data-[selected]/checkbox:scale-100 opacity-0 scale-75"
      >
