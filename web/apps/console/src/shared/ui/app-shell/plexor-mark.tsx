...
/**
 * Plexor brand mark, rendered without a background tile: the two squares use
 * `currentColor` (monochrome, adapts to light/dark), and the "P" keeps the
 * brand gradient from the source logo.
 */
export function PlexorMark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="57 120 385 260" fill="currentColor" aria-hidden="true" {...props}>
      <defs>
        <linearGradient
          id="plexor-mark-gradient"
          x1="140.977"
          y1="-3.74501"
          x2="522.712"
          y2="396.567"
